#!/usr/bin/env swift
//
// generate_icon.swift: Programmatically render Overland's macOS app icon —
...
//
// Usage: xcrun swift OverlandApp/Scripts/generate_icon.swift [preview.png]
//
...
let resourcesDir = (rootDir as NSString).appendingPathComponent("Sources/Overland/Resources")
