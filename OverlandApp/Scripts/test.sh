...
#
#   zsh OverlandApp/Scripts/test.sh            # Swift tests on this Mac (core + app)
#   zsh OverlandApp/Scripts/test.sh --docker   # core tests in a Linux container (what CI runs)
#   zsh OverlandApp/Scripts/test.sh --all      # both, plus the Rust gpapi tests touched by the app
#
...
run_docker() {
    echo "==> OverlandCore tests in Docker"
