...
public struct VpnViewModelStorage: @unchecked Sendable {
    ...
    public static func ephemeral(suiteName: String = "JeepNet.tests.\(UUID().uuidString)") -> VpnViewModelStorage {
...
public final class VpnViewModel: ObservableObject {
    ...
    private let profileDefaultsKey = "JeepNet.ConnectionProfile"
    private let useMockKey = "JeepNet.UseMockBridge"
    private let customBinaryKey = "JeepNet.CustomBinaryPath"
    ...
    private func observeAuthCallbacks() {
        callbackObserver = NotificationCenter.default.addObserver(
            forName: .jeepNetAuthCallbackReceived,
            object: nil,
            queue: .main
