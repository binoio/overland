...
final class BinaryLocatorTests: XCTestCase {
    func testCustomPathWinsWhenExecutable() {
        let locator = BinaryLocator(
            ...
            bundleURL: URL(fileURLWithPath: "/Applications/JeepNet.app"),
    ...
    func testBundledBinaryPrecedesHomebrew() {
        ...
        XCTAssertEqual(locator.resolveGpclient(custom: nil), "/Applications/JeepNet.app/Contents/MacOS/gpclient")
    }
    ...
    func testFallsBackToPathAndCargoTree() {
        let locator = BinaryLocator(
            ...
            workingDirectory: "/repo/JeepNetApp"
        )
...
final class SudoAskpassTests: XCTestCase {
    func testInstallWritesExecutableScript() throws {
        ...
        XCTAssertEqual(path, dir.appendingPathComponent("jeepnet-askpass.sh").path)
