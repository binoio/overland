...
final class GlobalProtectBridgeServiceTests: XCTestCase {
    ...
    private func makeService(
        ...
        return GlobalProtectBridgeService(
    ...
    func testSudoAskpassModeWrapsTunnelWithSudo() async throws {
        ...
        XCTAssertEqual(journal.commands.first?.environment["SUDO_ASKPASS"], tempDir.appendingPathComponent("gp-askpass.sh").path)
    }
    ...
    func testAuthorizationCancelledIsReportedAsPrivilegeProblem() async throws {
        ...
        let cancelling = GlobalProtectBridgeService(
            customGpclientPath: "/fake/gpclient",
