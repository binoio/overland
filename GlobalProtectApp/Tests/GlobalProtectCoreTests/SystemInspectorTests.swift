...
final class BinaryLocatorTests: XCTestCase {
    func testCustomPathWinsWhenExecutable() {
        let locator = BinaryLocator(
            ...
            bundleURL: URL(fileURLWithPath: "/Applications/GlobalProtect.app"),
    ...
    func testBundledBinaryPrecedesHomebrew() {
        ...
        XCTAssertEqual(locator.resolveGpclient(custom: nil), "/Applications/GlobalProtect.app/Contents/MacOS/gpclient")
    }
    ...
    func testFallsBackToPathAndCargoTree() {
        let locator = BinaryLocator(
            ...
            workingDirectory: "/repo/GlobalProtectApp"
        )
...
final class SudoAskpassTests: XCTestCase {
    func testInstallWritesExecutableScript() throws {
        ...
        XCTAssertEqual(path, dir.appendingPathComponent("gp-askpass.sh").path)
