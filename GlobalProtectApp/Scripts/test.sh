...
#
#   zsh GlobalProtectApp/Scripts/test.sh            # Swift tests on this Mac (core + app)
#   zsh GlobalProtectApp/Scripts/test.sh --docker   # core tests in a Linux container (what CI runs)
#   zsh GlobalProtectApp/Scripts/test.sh --all      # both, plus the Rust gpapi tests touched by the app
#
...
run_docker() {
    echo "==> GlobalProtectCore tests in Docker"
